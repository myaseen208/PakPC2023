#' @title Population and literacy rate for special age groups by rural/urban and sex
#' @name   TABLE_13A
#' @docType data
#' @keywords datasets
#' @usage data(TABLE_13A)
#' @description \code{TABLE_13A} Population and literacy rate for special age groups by rural/urban and sex
...
#'   \item{\code{VARS}}{VARS}
#'   \item{\code{AGE_BRACKET}}{AGE BRACKET}

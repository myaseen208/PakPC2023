#' @title Population by selected age group, sex and rural/urban
#' @name   TABLE_05
#' @docType data
#' @keywords datasets
#' @usage data(TABLE_05)
#' @description \code{TABLE_05} Population by selected age group, sex and rural/urban
...
#'   \item{\code{AGE_GROUP_IN_YEARS}}{AGE GROUP IN YEARS}
#'        }
#'

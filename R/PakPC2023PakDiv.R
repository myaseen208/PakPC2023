#' @title Divisional data from Pakistan Population Census 2023
#' @name   PakPC2023PakDiv
#' @docType data
#' @keywords datasets
#' @usage data(PakPC2023PakDiv)
#' @description \code{PakPC2023PakDiv} Pakistan data from Pakistan Population Census 2023.

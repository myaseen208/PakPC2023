#' @title Literacy rate, enrolments, and out-of-school population by sex and rural/urban
#' @name   TABLE_12
#' @docType data
#' @keywords datasets
#' @usage data(TABLE_12)
#' @description \code{TABLE_12} Literacy rate, enrolments, and out-of-school population by sex and rural/urban
